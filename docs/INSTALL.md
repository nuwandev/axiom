...
```bash
curl -LO https://github.com/nuwandev/axiom/releases/download/v1.1.0/axiom-1.1.0-1.x86_64.rpm
curl -LO https://github.com/nuwandev/axiom/releases/download/v1.1.0/SHA256SUMS
sha256sum -c SHA256SUMS --ignore-missing
sudo dnf install ./axiom-1.1.0-1.x86_64.rpm
```
...
curl -LO https://github.com/nuwandev/axiom/releases/download/v1.1.0/axiom-v1.1.0-linux-amd64
curl -LO https://github.com/nuwandev/axiom/releases/download/v1.1.0/SHA256SUMS
sha256sum -c SHA256SUMS --ignore-missing
chmod +x axiom-v1.1.0-linux-amd64

# the installer and systemd unit are small text files pulled directly from
# the tagged release, not the whole repo
curl -LO https://raw.githubusercontent.com/nuwandev/axiom/v1.1.0/scripts/install.sh
curl -LO https://raw.githubusercontent.com/nuwandev/axiom/v1.1.0/packaging/axiom.service
chmod +x install.sh
...
sudo BIN_SRC=./axiom-v1.1.0-linux-amd64 SYSTEMD_UNIT_SRC=./axiom.service ./install.sh
```
...
curl -Lo config.yaml https://raw.githubusercontent.com/nuwandev/axiom/v1.1.0/configs/example.yaml
